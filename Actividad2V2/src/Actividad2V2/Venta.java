...
public class Venta {
	...
	public HashSet<Venta> obtenerVentasHashSet(){
	...
	public void obtenerDatosVentas(HashSet<Venta> ventas) {
		...
		v.getFecha()+" - "+
		v.getCodarti().obtenerComprasId(ventas, v.getCodventa())+" - "+
		v.getCodarti().obtenerComprasId(ventas, v.getCodventa())*v.getCodarti().getPvp());
			};
	}
